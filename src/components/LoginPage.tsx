          ...
          <div className="mb-8 p-4 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl">
            ...
            <div className="flex justify-center">
              <button 
                ...
                className="w-full bg-orange-500/20 hover:bg-orange-500/30 border border-orange-500/30 text-orange-300 font-black uppercase tracking-widest py-3 rounded-xl text-[10px] flex items-center justify-center gap-2 transition-all"
              >
                Advocate Portal Login <ArrowRight size={12} />
              </button>
            </div>
          </div>
